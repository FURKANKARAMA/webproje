...
namespace webproje2021.Controllers
{
    public class urunlerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,urunadi,kalori,fiyati,resim,kategori")] urunler urunler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,urunadi,kalori,fiyati,resim,kategori")] urunler urunler)
        {
            if (id != urunler.Id)
            {
                return NotFound();
